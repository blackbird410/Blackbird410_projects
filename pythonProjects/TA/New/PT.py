...
def open_n_data():
    ...
    def button_save_node():
        ...
        node_dict = {'Node number': l_node_num, 
                        'Position X': l_x_pos, 
                        'Position Y': l_y_pos,
                        'Reaction X': l_x_reaction, 
                        'Reaction Y': l_y_reaction}
    ...
    frame_1 = LabelFrame(n_data, 
                        text='Data entry', 
                        padx=15, 
                        pady=20, 
                        font=("Helvetica", 10), 
                        bg='#fb0')
    frame_2 = LabelFrame(n_data, 
                        text='Database', 
                        padx=15, 
                        pady=20, 
                        font=("Helvetica", 10), 
    ...
    c_1 = Checkbutton(frame_1, 
                        text='Reaction on the X axis', 
                        font=("Helvetica", 10), bg='#fb0', 
                        variable=v_1)
